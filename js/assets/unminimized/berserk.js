  ...
  */
  ...
  $(function () {
    ...
    var fonts = {
      ...
      '.font__family-montserrat': 'tajwal-med:100,200,300,400,500,600,700',
      ...
      '.font__family-montserrat-alt': 'tajwal-med+Alternates:400,700'
    };
  ...
  var adds = {
    ...
    lazyUrls = {
      "component__map": {
        "js": [
          "https://maps.googleapis.com/maps/api/js?key=AIzaSyDhnmMC23noePz6DA8iEvO9_yNDGGlEaeM" + Berserk.settings.gmap_api_key,
